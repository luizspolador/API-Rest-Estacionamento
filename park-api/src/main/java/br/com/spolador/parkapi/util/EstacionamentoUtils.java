package br.com.spolador.parkapi.util;
...
public class EstacionamentoUtils {
    ...
    public static String gerarRecibo(){
        ...
        return recibo.replace("-", "") // remove - e junta
                .replace(":", "") // remove os : e junta
                .replace("T", "-"); // remove T e coloca um -
    }
    ...
    public static BigDecimal calcularDesconto(BigDecimal custo, long numeroDeVezes) {
        BigDecimal desconto = ((numeroDeVezes > 0) && (numeroDeVezes % 10 == 0)) // Quando for zero, significa que o valor atual contido na variável é 10 ou 20 ou 30 ou 40...
